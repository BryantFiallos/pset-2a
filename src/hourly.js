...
const thisWeekPayRounded = thisWeekPay.toFixed(2);
const thisWeekPayDisplay = thisWeekPayRounded.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,')

console.log("\nYou'll make $" + thisWeekPayDisplay + " this week.")
